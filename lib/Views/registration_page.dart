...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  {
    _registrationPageModel.registerWithEmailAndPassword(email, password).then((value) => null).catchError((err){
  ...
  _handleLoginError(String errorCode)
  {
    ...
    DialogBox(context: context, heading: "Registration failure", content: errorMsg).show();
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: RegistrationWidget(onRegister: _onRegisterClicked ,
                      emailValidator: _registrationPageModel.emailValidator,
                      passwordValidator: _registrationPageModel.passwordValidator),
                ),
                Padding(
                  padding: EdgeInsets.only(
