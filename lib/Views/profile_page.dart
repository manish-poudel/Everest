...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget _buildUserInfo({BuildContext context}) {
    ...
    return Column(
      ...
      children: [
        user.userProfileUrl.isEmpty || user.userProfileUrl == null?Icon(Icons.account_circle, color: Colors.grey[300],
        ...
        Text(user.firstName + " "+ user.lastName, style: TextStyle(fontFamily: _appConfig.fontFamily, fontWeight: FontWeight.w500)),
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.brightness_1, color: Colors.green,size: 8,),
            Padding(
              padding: EdgeInsets.only(left:ScreenUtility.getStandardPadding(context)),
              child: Text("Available", style: TextStyle(fontFamily: _appConfig.fontFamily, fontWeight: FontWeight.w500)),
            ),
          ],
        ),
      ],
