          ...
          Row(
            ...
            children: [
              SizedBox(
                ...
                child: FlatButton(
                  color: searchBoxFilterModel.filterUsernameActive?Colors.grey[200]:Colors.white,
                  ...
                  child: Text("name",style: TextStyle(
                      fontSize: ScreenUtility.getStandardSize8(context) * 1.6,
                      fontFamily: appConfig.fontFamily)),
                  onPressed: () => searchBoxFilterModel.onFilterUsernameChanged(),
                ),
              ),
              Padding(
                ...
                child: SizedBox(
                  height: MediaQuery.of(context).size.height * 0.04,
                  child: FlatButton(
                    color: searchBoxFilterModel.filterNameActive?Colors.grey[200]:Colors.white,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(ScreenUtility.getStandardSize8(context) * 3),
                        side: BorderSide(color: Colors.grey[200])
                    ),
                    child: Text("username",style: TextStyle(
                      fontSize: ScreenUtility.getStandardSize8(context) * 1.6,
                        fontFamily: appConfig.fontFamily)),
                    onPressed: ()=>  searchBoxFilterModel.onFilterNameChanged(),
                  ),
                ),
              )
            ],
